...
<form method="post">
    ...
    <div id="PiloteInterne" style="display: <?= (isset($lePilote[0]['statut']) && $lePilote[0]['statut'] === 'PiloteInterne') ? 'block' : 'none' ?>; color: green;">
    ...
    <div id="PiloteExterne" style="display: <?= (isset($lePilote[0]['statut']) && $lePilote[0]['statut'] === 'PiloteExterne') ? 'block' : 'none' ?>; color: yellow;">
